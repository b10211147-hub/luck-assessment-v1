(() => {
  ...
  const deityLenses = {
    "無極老母娘": {
      career: "先安住心，不用靠工作成敗證明自己的價值", love: "真心不必追趕，也不該用委屈交換", people: "善待別人之前，也要把自己的心照顧好", exam: "照自己的節奏扎根，不被他人的速度擾亂", family: "柔軟不是退讓，而是替家人留一條回來的路", health: "累了就休息，不必為需要照顧而自責"
    },
    "驪山老母": {
      career: "先讓能力配得上機會，再談位置與掌聲", love: "清醒觀察長期行動，不被短暫熱烈迷惑", people: "規矩與界線說得清楚，關係才能長久", exam: "調整方法、理解原理，比死背更能突破", family: "愛也需要清楚分工，不能用含糊維持和平", health: "面對警訊要查明，不拖延也不自行猜測"
    },
    "瑤池金母": {
      career: "把眼光放到長遠，以品德與格局承接位置", love: "彼此尊重且各自完整，才有長久的好緣", people: "選擇價值觀相近的人，不只看眼前能力", exam: "先建立秩序與架構，知識才容易融會貫通", family: "家中有序、彼此有分寸，福氣才住得安穩", health: "照顧自己是尊重生命，不等倒下才承認疲憊"
    },
    "觀音菩薩": {
      career: "不必把所有責任都扛在自己身上", love: "放下控制與猜測，讓真心有呼吸的空間", people: "先聽見對方未說出口的苦，再決定如何回應", exam: "不懂時勇敢求助，開口就可能遇見一盞燈", family: "家人的尖銳背後，也許藏著沒有被聽見的委屈", health: "允許自己慢下來，身心才有機會真正跟上"
    },
    "玄天上帝": {
      career: "方向若正就要果決，先除內耗再向前", love: "不清不楚的關係，必須用真話照明", people: "面對爭議靠事實、紀錄與正當程序", exam: "紀律比一時情緒可靠，該做的功課不能逃", family: "該立的規矩要立，安全與責任不能含糊", health: "勇敢不是硬撐，而是及時檢查與處理"
    },
    "九天玄女": {
      career: "先看全局與關鍵節點，再集中資源出手", love: "不要只看當下甜苦，要看長期互動模式", people: "先對齊資訊與利益，再決定信任的深度", exam: "用系統串起知識，找出能帶動全局的弱點", family: "先消除資訊落差，許多誤解便不攻自破", health: "找出真正耗能的來源，減少雜訊與反覆切換"
    },
    "地母元君": {
      career: "務實耕耘每天可累積的事，根穩才走得遠", love: "真心要看日常是否願意照顧、分擔與守信", people: "可靠比花俏重要，先看對方如何完成小事", exam: "基本功不能省，日日重溫才能臨場從容", family: "家不是一個人撐起來的，要讓眾人一起分擔", health: "回到規律作息與正常生活，比追求奇法可靠"
    },
    "中壇元帥": {
      career: "先做出可驗證的小成果，再邊走邊修正", love: "喜歡就真誠表達，不用冷淡與猜心包裝", people: "講義氣也要講道理，不替別人扛完後果", exam: "把難題變成關卡，親手做過會記得更牢", family: "有話直說但把聲音放低，別讓急心變怒氣", health: "別只困在腦中，適量活動能幫助身心換氣"
    },
    "下壇元帥": {
      career: "先把每件答應的小事做好，信用自然累積", love: "關心要讓對方感受到，承諾也要做得到", people: "未查證的話不傳，重要事情直接問當事人", exam: "每天學一點，比偶爾熬夜拼命更有用", family: "看見日常付出，一句感謝能化開許多怨氣", health: "水要喝、飯要吃、覺要睡，先把基本照顧做好"
    }
  };
